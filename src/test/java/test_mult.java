...
public class test_mult {
    ...
    public void mult() {
        ...
        calc.num1.click();
        calc.num1.sendKeys("4");
        calc.num2.click();
        calc.num2.sendKeys("3");
        calc.mult.click();
        // Так как в приложении поле вывода результата реализовано в виде: 4.00 * 3.00 = 12.00
        //assert(calc.result.getText().equals("4.00 * 3.00 = 12.00"));
        if (calc.result.getText().equals("4.00 * 3.00 = 12.00")) {
