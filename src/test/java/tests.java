...
public class tests {
    ...
    public void add_test() {
        ...
        calc.num1.click();
        calc.num1.sendKeys("3");
        calc.num2.click();
        calc.num2.sendKeys("4");
        calc.add.click();
        // Так как в приложении поле вывода результата реализовано в виде: 3.00 + 4.00 = 7.00
        //assert(calc.result.getText().equals("3.00 + 4.00 = 7.00"));
        if (calc.result.getText().equals("3.00 + 4.00 = 7.00")) {
