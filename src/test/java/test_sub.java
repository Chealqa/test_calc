...
public class test_sub {
    ...
    public void sub() {
        ...
        calc.sub.click();
        // Так как в приложении поле вывода результата реализовано в виде: 4.00 - 3.00 = 1.00
        //assert(calc.result.getText().equals("4.00 - 3.00 = 1.00"));
        if (calc.result.getText().equals("4.00 - 3.00 = 1.00")) {
